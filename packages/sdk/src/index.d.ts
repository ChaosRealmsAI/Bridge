...
export const bridgeDesktopInstallDefaults: Readonly<{
  macos: Readonly<{
    ...
    versionedFileName: "bridge-desktop-v0.1.0-macos.dmg";
    version: "0.1.0";
    openUrl: "bridge://open";
    downloadPath: "/downloads/bridge-macos.dmg";
    versionedDownloadPath: "/downloads/releases/v0.1.0/bridge-desktop-v0.1.0-macos.dmg";
  ...
  windows: Readonly<{
    ...
    versionedFileName: "bridge-desktop-v0.1.0-windows-x64.zip";
    version: "0.1.0";
    openUrl: "bridge://open";
    downloadPath: "/downloads/bridge-windows-x64.zip";
    versionedDownloadPath: "/downloads/releases/v0.1.0/bridge-desktop-v0.1.0-windows-x64.zip";
    downloadUrls: Readonly<Record<string, string>>;
    sha256: string;
  }>;
}>;
