...
export const bridgeDesktopInstallDefaults = Object.freeze({
  macos: Object.freeze({
    platform: "macos",
    appName: "Bridge",
    fileName: "bridge-macos.dmg",
    versionedFileName: "bridge-desktop-v0.1.1-macos.dmg",
    version: "0.1.1",
    openUrl: "bridge://open",
    downloadPath: "/downloads/bridge-macos.dmg",
    versionedDownloadPath: "/downloads/releases/v0.1.1/bridge-desktop-v0.1.1-macos.dmg",
    downloadUrls: Object.freeze({
      production: "https://assets.bridge.chaos-realms.cc/downloads/bridge-macos.dmg",
      test: "https://assets-bridge-test.chaos-realms.cc/downloads/bridge-macos.dmg",
    }),
  ...
  windows: Object.freeze({
    platform: "windows",
    appName: "Bridge",
    fileName: "bridge-windows-x64.zip",
    versionedFileName: "bridge-desktop-v0.1.1-windows-x64.zip",
    version: "0.1.1",
    openUrl: "bridge://open",
    downloadPath: "/downloads/bridge-windows-x64.zip",
    versionedDownloadPath: "/downloads/releases/v0.1.1/bridge-desktop-v0.1.1-windows-x64.zip",
    downloadUrls: Object.freeze({
      production: "https://assets.bridge.chaos-realms.cc/downloads/bridge-windows-x64.zip",
      test: "https://assets-bridge-test.chaos-realms.cc/downloads/bridge-windows-x64.zip",
    }),
...
export function createBridgeClient(options = {}) {
  ...
  const createAuthorizationIntent = async (input = {}) =>
    request("POST", "/v1/connect-intents", {
      ...
      device_name: input.deviceName || input.device_name || "Bridge Desktop",
  ...
  return {
    ...
    devices: {
      ...
      createPairingCode: (deviceName = "Bridge Desktop") =>
...
function preflightAction(code) {
  const labels = {
    ...
    connect_device: "Connect Bridge Desktop to this account.",
    open_desktop: "Open Bridge Desktop and keep it online.",
