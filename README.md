...
- [当前产品路线](spec/gate/routes/v5-sdk-readiness-preflight.md)
...
```text
spec/verification/evidence/v5-sdk-readiness-preflight/spec-traceability-summary.json
spec/verification/v5-sdk-readiness-preflight.html
```
