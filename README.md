...
- [最终架构](spec/architecture/final-design.md)
- [Job 协议](spec/protocol/job-protocol.md)
- [安全和授权模型](spec/security/authorization-model.md)
- [用户体验流程](spec/product/ux-flow.md)
- [开源和产品边界](spec/product/open-source-model.md)
- [飞书 CLI 集成设计](spec/integrations/feishu-cli.md)
- [MVP 路线图](spec/roadmap/mvp.md)
...
```text
spec/evidence/local-smoke/summary.json
spec/evidence/cloud-smoke/summary.json
spec/evidence/desktop-lite-smoke/summary.json
spec/evidence/browser-smoke/summary.json
spec/evidence/browser-smoke/bridge-browser-e2e.png
spec/evidence/mobile-browser-smoke/summary.json
spec/evidence/mobile-browser-smoke/mobile-chat-reply.png
```
