...
- [当前产品路线](spec/gate/routes/v3-request-safety-boundaries.md)
...
```text
spec/verification/evidence/v3-request-safety-boundaries/spec-traceability-summary.json
spec/verification/v3-request-safety-boundaries.html
```
