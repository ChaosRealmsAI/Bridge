...
- [当前产品路线](spec/gate/routes/v1-spec-rebuild-alignment.md)
...
```text
spec/verification/evidence/v1-spec-rebuild-alignment/spec-traceability-summary.json
spec/verification/v1-spec-rebuild-alignment.html
```
