...
- [当前产品路线](spec/gate/routes/v2-invocation-diagnostics.md)
...
```text
spec/verification/evidence/v2-invocation-diagnostics/spec-traceability-summary.json
spec/verification/v2-invocation-diagnostics.html
```
