...
const source = resolve("apps/desktop/assets/bridge-icon.svg");
const iconset = resolve("apps/desktop/assets/Bridge.iconset");
const output = resolve("apps/desktop/assets/Bridge.icns");
