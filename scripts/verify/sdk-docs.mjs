...
const callingGuide = optionalRead("spec/L4/reference-materials/docs/sdk-calling-guide.md");
const productIntegration = optionalRead("spec/L4/reference-materials/docs/product-integration.md");
const desktopUserGuide = optionalRead("spec/L4/reference-materials/docs/desktop-user-guide.md");
...
for (const doc of [
  ...
  optionalDoc("spec/L4/reference-materials/docs/sdk-calling-guide.md", callingGuide),
  optionalDoc("spec/L4/reference-materials/docs/product-integration.md", productIntegration),
].filter(Boolean)) {
  const [name, text] = doc;
  for (const marker of [
    "createBridgeServerClient",
...
for (const [name, text] of [
  optionalDoc("spec/L4/reference-materials/docs/desktop-user-guide.md", desktopUserGuide),
].filter(Boolean)) {
  for (const marker of [
    "AI runtime",
    "local Agent",
...
console.log(JSON.stringify({
  ...
  docs: [
    ...
    callingGuide ? "spec/L4/reference-materials/docs/sdk-calling-guide.md" : null,
    productIntegration ? "spec/L4/reference-materials/docs/product-integration.md" : null,
    "examples/minimal-caller/README.md",
    desktopUserGuide ? "spec/L4/reference-materials/docs/desktop-user-guide.md" : null,
  ].filter(Boolean),
...
function optionalRead(rel) {
  const file = resolve(root, rel);
  return existsSync(file) ? readFileSync(file, "utf8") : null;
}

function optionalDoc(name, text) {
