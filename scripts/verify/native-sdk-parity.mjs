...
const android = read("packages/native/android/src/main/java/cc/bridge/sdk/BridgeRelaySdk.kt");
const ios = read("packages/native/ios/Sources/BridgeKit/BridgeRelay.swift");
