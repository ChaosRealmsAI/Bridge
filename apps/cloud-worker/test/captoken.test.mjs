...
console.log(`captoken js vectors: claims=${vectors.claim_cases.length} envelope=${vectors.envelope_cases.length} signatures=${vectors.signature_cases.length} bnd=${vectors.boundary_cases.length}`);
