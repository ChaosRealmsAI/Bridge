...
export const BRIDGE_DESKTOP_RELEASE = Object.freeze({
  ...
  manifest: Object.freeze({
    ...
    versioned_path: "/downloads/releases/v0.1.1/panda-bridge-desktop-v0.1.1.json",
  }),
  targets: Object.freeze({
    macos: Object.freeze({
      ...
      versioned_file_name: "panda-bridge-desktop-v0.1.1-macos.dmg",
      ...
      versioned_download_path: "/downloads/releases/v0.1.1/panda-bridge-desktop-v0.1.1-macos.dmg",
    ...
    windows_x64: Object.freeze({
      ...
      versioned_file_name: "panda-bridge-desktop-v0.1.1-windows-x64.zip",
      ...
      versioned_download_path: "/downloads/releases/v0.1.1/panda-bridge-desktop-v0.1.1-windows-x64.zip",
