...
fn show(args: ShowArgs) -> Result<()> {
    let detail = if let Some(transcript_path) = args.transcript_path.as_deref() {
        burn_monitor::show_session_at_path_for_agent(
            transcript_path,
            &args.id,
            args.agent.as_deref(),
            args.cursor,
        ...
        burn_monitor::show_session_in_project_for_agent_page(
            project,
            &args.id,
            args.agent.as_deref(),
            args.cursor,
        ...
        burn_monitor::show_session_for_agent_page(
            &args.id,
            args.agent.as_deref(),
            args.cursor,
            args.limit,
