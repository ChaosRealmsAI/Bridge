    ...
    return {
      ...
      api: {
        cli: {
          ...
          "burn agent observer status/sources/deltas/watch/perf": true,
          "burn agent abnormal watch/list/scan": true,
        },
        desktop_actions: {
          ...
          "agent.observer.status": true,
          "agent.observer.sources": true,
          "agent.observer.deltas.list": true,
          "agent.observer.watch.start": true,
          "agent.observer.watch.stop": true,
          "agent.observer.perf": true,
          "agent.abnormal.watch": true,
          "agent.abnormal.list": true,
          "agent.abnormal.scan": true,
        },
        bridge_commands: {
          ...
          "burn.agent.turn.interrupt": true,
          "burn.agent.observer.status": true,
          "burn.agent.observer.sources": true,
          "burn.agent.observer.deltas.list": true,
          "burn.agent.observer.watch.start": true,
          "burn.agent.observer.watch.stop": true,
          "burn.agent.observer.perf": true,
          "burn.agent.abnormal.watch": true,
          "burn.agent.abnormal.list": true,
          "burn.agent.abnormal.scan": true,
        },
      },
