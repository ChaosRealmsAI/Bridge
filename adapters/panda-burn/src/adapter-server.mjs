...
import { createBridgeProductAdapterRuntime } from "@panda-bridge/adapter-sdk";
...
export async function startPandaBurnAdapter(options = {}) {
  ...
  return createBridgeProductAdapterRuntime({
    ...
    keyB64: options.keyB64 || process.env.PANDA_BURN_RELAY_KEY_B64 || process.env.PANDA_BRIDGE_RELAY_KEY_B64,
